...
/******/ 	var hotCurrentHash = "f8dc8d67900320af19ec"; // eslint-disable-line no-unused-vars
...
var Home = exports.Home = function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function render() {
      ...
      var tasksToRender = this.state.todos.map(function (task) {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'strong',
              null,
              this.state.todos.filter(function (key) {
                return !key.done;
              }).length
            ),
            ' item left'
